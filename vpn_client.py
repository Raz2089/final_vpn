...
def collect_data_from_server(): #also reinject back to packet buffer
    with pydivert.WinDivert("false") as w:
        while True:
            ...
            print("recieved back from my server from" , packet_from_server.src_addr , packet_from_server.dst_port , "this is the data" , packet_from_server.payload)
...
def collect_packets_from_user():
    ...
    f = "outbound and (tcp or udp) and (ip.DstAddr == 10.10.10.165 or ip.DstAddr == 10.10.10.165)"
    ...
    with pydivert.WinDivert(f) as w:
        while True:
            ...
            print("sent this packet to server to" , packet.dst_addr , packet.dst_port , "this is the payload: " , packet.payload)
